...
type Feature = {
  ...
  color: string; // tailwind text color utility
  blurb: string;
  details: string;
};
      ...
      <section className="mt-14">
        <div className="rounded-3xl border border-zinc-200/70 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-zinc-900">
          ...
          <div className="mt-4">
            <a
              href="/signup"
              className="inline-flex items-center justify-center rounded-xl bg-rose-600 px-4 py-2 font-medium text-white hover:opacity-90"
            >
              Sign up for updates
            </a>
          </div>
        ...
        {open ? (
          <div className="space-y-3">
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400">
              Learn more on the{" "}
              <a className="underline decoration-rose-400 underline-offset-4 hover:opacity-90" href="/security">
                Security
              </a>{" "}
              page.
            </p>
